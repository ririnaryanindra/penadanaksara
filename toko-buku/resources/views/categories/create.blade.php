...
<div class="container container-small px-5 py-6">
    <p style="font-size: 1.5rem; font-weight: 600;" class="mb-3">Tambah Kategori Baru</p>
    ...
    <form method="POST" action="/categories">
        ...
        <div class="button-group">
            <button type="submit" class="rounded-lg bg-indigo-600 px-3 py-1.5 text-white font-semibold text-sm hover:bg-indigo-700 transition focus:outline-none focus:ring-2 focus:ring-indigo-500">Simpan</button>
